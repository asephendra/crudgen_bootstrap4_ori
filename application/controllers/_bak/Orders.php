...
class Orders extends Admin_Controller 
{
	...
	*/
	...
	public function create_edit()
	{
		...
		$this->data['page_title'] = 'Add Order Edit';
        ...
        if ($this->form_validation->run() == TRUE) {        	
            ...
            $this->render_template('orders/create_edit', $this->data);
        }	
	}
	...
	*/
	public function getBarangValueById()
	{
		...
		if($product_id) {
			$product_data = $this->model_products->getBarangData($product_id);
	...
	*/
	...
	{
		$products = $this->model_products->getBarangData();
