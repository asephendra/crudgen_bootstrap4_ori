	...
	*/
	public function fetchBrandData()
	{
		...
		foreach ($data as $key => $value) {
			...
			// if(in_array('viewBrand', $this->permission)) {
				$buttons .= '<button type="button" class="btn btn-sm btn-info" onclick="editBrand('.$value['id'].')" data-toggle="modal" data-target="#editBrandModal">Edit</button>';	
			// }
			...
			$buttons .= '<button type="button" class="btn btn-sm btn-outline-warning" onclick="editBrand('.$value['id'].')" data-toggle="modal" data-target="#editBrandModal">Edit</button>';			
