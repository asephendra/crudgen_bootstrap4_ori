...
class Crud_generator
{
	...
	public function __construct()
	{
		...
		$this->view_path_folder = APPPATH.'/views/';		
	}
	...
	public function build_view_index($get_model, $get_view, $get_controller, $get_table, $get_field, $get_title)
	{
		$this->load->library('parser');
		$this->load->helper('file');
		#$class_name = ucfirst($get_controller);
		...
		$source_template = $this->parser->parse('generator/template/form_view/index_bootstrap', $data, TRUE);
		...
		$build = write_file($folder_view.'/index.php', $source_template);
		if($build === TRUE)
		{
