          ...
          <?php endif; ?>
           <div class="box">
            <div class="box-header">
              <h3 class="box-title">Report Simaset</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="datatables" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td>Laporan Semua Aset</td>
                      <td>
                        <a href="#" class="button btn-link btn-lg">Lihat laporan</a>
                      </td>
                    </tr>
                    <tr>
                      <td>3</td>
                      <td>Laporan Penyusutan</td>
                      <td>
                        <a href="<?php echo base_url('penyusutan')?>" class="button btn-link btn-lg">Lihat Penyusutan</a>
                      </td>
                    </tr>
                    <tr>
                      <td>4</td>
                    ...
                    <tr>
                      ...
                      <td>Laporan Semua Aset</td>
                      <td>
                        <a href="<?php echo base_url('aset')?>" class="button btn-link btn-lg">Lihat laporan</a>
                      </td>
                    </tr>
                    <tr>
                      <td>6</td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('category/cetak') ?>" method="post" id="createForm">
        ...
        <div class="modal-footer">
          <a href="<?php echo base_url('category/cetak') ?>" target="_blank" class="btn btn-primary"> Buat laporan</a>
  ...
  <script type="text/javascript">
    ...
    barChartData.datasets[0].pointColor  = '#444';
    var barChartOptions                  = {
