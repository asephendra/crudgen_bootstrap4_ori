  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createTabel', $user_permission)): ?>
        ...
        <div class="box box-primary">
          <div class="box-header">
            <h3 class="box-title">Manage Tabel</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <table id="manageTable" class="table table-bordered table-striped">
              ...
              <tr>
                <th>Kolom 1</th>
                <th>Kolom 2</th>
                <?php if(in_array('updateTabel', $user_permission) || in_array('deleteTabel', $user_permission)): ?>
                  <th>Action</th>
                <?php endif; ?>
              </tr>
              <!-- ******************* -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Add Tabel</h4>
      </div>

      <form role="form" action="<?php echo base_url('table/create') ?>" method="post" id="createTabelForm">
...
<?php if(in_array('updateTabel', $user_permission)): ?>
<!-- edit brand modal -->
<div class="modal fade" tabindex="-1" role="dialog" id="editTabelModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('tabel/update') ?>" method="post" id="updateTabelForm">
        <div class="modal-body">
          <div id="messages"></div>
...
<?php if(in_array('deleteTabel', $user_permission)): ?>
<!-- remove brand modal -->
<div class="modal fade" tabindex="-1" role="dialog" id="removeTabelModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('tabel/remove') ?>" method="post" id="removeTabelForm">
        <div class="modal-body">
